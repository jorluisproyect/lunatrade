const CACHE='lunatrade-v8-shell';
const SHELL=['/','/manifest.webmanifest','/static/styles.css?v=8.0','/static/app.js?v=8.0','/static/icons/icon-192.png','/static/icons/icon-512.png'];
